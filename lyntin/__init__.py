...
__version__ = "4.2"
# __version__ = 'cvs-dev'
__version_tuple__ = (4, 2, 1)  # major, minor, minor minor
__author__ = "Will Guaraldi <willhelm@users.sourceforge.net>, Servus Dei <servusdei@programmer.net>"
__url__ = "http://lyntin.sourceforge.net/"

__copyright__ = "(C) 2003-2020 FSF"
__license__ = "GPLv3"
