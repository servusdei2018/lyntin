...
bugs = """
Lyntin was originally written by Lyn Headley. Lyntin was 
 maintained by Will Guaraldi (willhelm@users.sourceforge.net) 
as of 1.3.2. Currently, Lyntin is maintained by Servus Dei
(servusdei@programmer.net | github.com/servusDei2018)
...
Details for both are on the old Lyntin web-site:

   http://lyntin.sourceforge.net/
   
For new bugs, see:

   http://github.com/servusDei2018/lyntin
