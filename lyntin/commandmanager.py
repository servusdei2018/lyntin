...
class _CommandData:
  ...
  """
    ...
    def setNameAdjusted(self, name):
        self._name_adjusted = name

    def getNameAdjusted(self):
        return self._name_adjusted
...
class CommandManager(manager.Manager):
  ...
  """
    ...
    """
        ...
        # removeCommand tests to see if the command already exists and
        # removes it if it does
        self.removeCommand(name)

        # enter the command into a dict
    ...
    """
        ...
        if len(input) > 1 and input.startswith(commandchar):
            ...
            # gets command name and strips arguments
            words = input.split(" ", 1)
            ...
            # check to see if it's a special #@ command.
            if input.startswith("@"):
            ...
            # find the first matching command and end there
            ...
            for mem in commands:
                ...
                if command:
                    ...
                    if argumentparser == None:
                        ...
                        # to print out the error message, remove the ^
